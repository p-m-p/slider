...
export default function ContentSection({ children, title, titleComponent = 'h2', ...props }: ContentSectionProps) {
  ...
  return (
    <section className="container mx-auto bg-neutral-900 p-4 md:p-8 pb-0 rounded mb-8" {...props}>
      {titleEl}
      {children}
    </section>
  )
