...
export default function ExampleCard({ description, level, title, url }: ExampleCardProps) {
  ...
  return (
    <div>
      <div className="text-right">
        ...
        <span className="uppercase text-neutral-600 text-sm font-bold mx-2">{level}</span>
      </div>
